...
public class DrumKit implements MouseListener {
	...
	public void run() throws MalformedURLException {
		...
		String image = "igniter-large.jpg";

		// 9. Edit the next line to use your String variable
		drumLabelWithImage = createLabelImage(image);
		
		String second = "cymbal.jpg";
		
		cymbalLabelWithImage = createLabelImage(second);
		
		String third = "snare.jpg";
		
		snareLabelWithImage = createLabelImage(third);

		// 10. Add the image to the panel
		pan.add(drumLabelWithImage);
		pan.add(cymbalLabelWithImage);
		pan.add(snareLabelWithImage);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(drumClicked == snareLabelWithImage) {
			playSound("snare.wave");
		}
